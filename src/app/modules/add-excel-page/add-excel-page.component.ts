...
@Component({
  selector: 'app-add-excel-page',
  templateUrl: './add-excel-page.component.html',
  styleUrls: ['./add-excel-page.component.scss'],
})
export class AddExcelPageComponent implements OnInit {
